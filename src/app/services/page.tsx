...
const services = [
  { Icon: AcIcon, title: 'AC Repair & Service', href: '/services/air-conditioner', color: '#2563eb', colorLight: '#eff6ff', colorBorder: '#bfdbfe',
  ...
  { Icon: WashingMachineIcon, title: 'Washing Machine Repair', href: '/services/washing-machine', color: '#7c3aed', colorLight: '#f5f3ff', colorBorder: '#ddd6fe',
  ...
  { Icon: RefrigeratorIcon, title: 'Refrigerator Repair', href: '/services/refrigerator', color: '#0891b2', colorLight: '#ecfeff', colorBorder: '#a5f3fc',
  ...
  { Icon: TvIcon, title: 'Television Repair', href: '/services/television', color: '#be123c', colorLight: '#fff1f2', colorBorder: '#fecdd3',
  ...
  { Icon: MicrowaveIcon, title: 'Microwave Oven Repair', href: '/services/microwave', color: '#d97706', colorLight: '#fffbeb', colorBorder: '#fde68a',
...
const trust = [
  ...
  { Icon: Banknote, label: '₹399 Inspection' },
        ...
        <div className="space-y-6">
          {services.map((s, i) => (
            <Link key={s.href} href={s.href}
              className="group flex flex-col sm:flex-row gap-6 bg-white rounded-2xl shadow-card hover:shadow-card-hover hover:-translate-y-1 border border-gray-100 hover:border-brand-200 p-7 transition-all duration-300 cursor-pointer"
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-400 font-medium"><span className="font-semibold text-gray-600">Brands: </span>{s.brands}</p>
              </div>
