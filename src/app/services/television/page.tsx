...
export const metadata: Metadata = {
  title: 'TV Repair in Madurai | LED, LCD, Smart TV',
  description:
    'TV repair in Madurai — LED, LCD, OLED, Smart TV panel, board, sound & display issues. Sony, LG, Samsung, Panasonic. 90-day warranty. Call 8838893560.',
