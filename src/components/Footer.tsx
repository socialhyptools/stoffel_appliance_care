          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white font-black text-lg"
                  style={{ background: 'linear-gradient(135deg,#2563eb 0%,#1e3a8a 100%)' }}>A</div>
                <div>
              ...
              <p className="text-sm leading-relaxed text-gray-400 mb-5">
                Trichy's most trusted home appliance repair service. Doorstep convenience, certified experts, genuine parts.
              </p>
              <a href="tel:+919344809038"
                className="inline-flex items-center gap-2 text-accent-400 font-bold text-base hover:text-accent-300 transition-colors">
                📞 93448 09038
              </a>
                ...
                {socialLinks.map((s) => (
                  <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label}
                    className="w-9 h-9 rounded-xl flex items-center justify-center
                               bg-white/5 hover:bg-brand-600 text-gray-400 hover:text-white
                ...
                {services.map((s) => (
                  <li key={s.href}>
                    <Link href={s.href}
                      ...
                      <span className="w-1 h-1 rounded-full bg-brand-500 group-hover:bg-accent-500 transition-colors" />
                      {s.label}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <address className="not-italic text-sm space-y-3 text-gray-400">
                ...
                <p><a href="tel:+919344809038" className="hover:text-white transition-colors">📞 93448 09038</a></p>
                <p>⏰ Mon – Sun · 8:00 AM – 8:00 PM</p>
              </address>
              <a href="https://wa.me/919344809038" target="_blank" rel="noopener noreferrer"
                className="mt-5 inline-flex items-center gap-2.5 min-h-[48px] px-5 py-3
                           text-sm font-semibold text-white rounded-xl transition-all duration-200 hover:-translate-y-0.5"
