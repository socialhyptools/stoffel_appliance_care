...
const socialLinks = [
  ...
  { label: 'WhatsApp', href: 'https://wa.me/919344809038', icon: <WhatsAppIcon className="w-5 h-5" /> },
  ...
  return (
    <footer style={{ background: 'linear-gradient(180deg,#0c1428 0%,#070e2b 100%)' }} className="text-gray-400 mt-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white font-black text-lg" style={{ background: 'linear-gradient(135deg,#2563eb 0%,#1e3a8a 100%)' }}>A</div>
                <div>
                  <div className="text-white font-extrabold text-sm tracking-tight">Appliance Service Experts</div>
                  <div className="text-blue-400 text-[11px] font-medium">Trichy, Tamil Nadu</div>
                </div>
              </div>
              <p className="text-sm leading-relaxed text-gray-400 mb-5">Trichy&apos;s most trusted home appliance repair service. Doorstep convenience, certified experts, genuine parts.</p>
              <a href="tel:+919344809038" className="inline-flex items-center gap-2 text-accent-400 font-bold text-base hover:text-accent-300 transition-colors">
            ...
            <div>
              ...
              <address className="not-italic text-sm space-y-3 text-gray-400">
                <p className="flex items-center gap-2"><MapPin className="w-4 h-4 flex-shrink-0" /> Tiruchirappalli, Tamil Nadu, India</p>
                <p><a href="tel:+919344809038" className="flex items-center gap-2 hover:text-white transition-colors"><Phone className="w-4 h-4 flex-shrink-0" /> 93448 09038</a></p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-gray-600">
        <p>&copy; {new Date().getFullYear()} Appliance Service Experts. All rights reserved.</p>
