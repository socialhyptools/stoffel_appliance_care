...
const socialLinks = [
  ...
  {
    label: 'WhatsApp', href: 'https://web.whatsapp.com/send?phone=918778783255&text=',
      ...
      <div className="bg-brand-900 text-blue-200 text-xs py-2 hidden sm:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex justify-between items-center">
          <div className="flex items-center gap-6">
            ...
            <a href="tel:+918838893560" className="hover:text-white transition-colors flex items-center gap-1.5">
              📞 88388 93560
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              <a href="tel:+918838893560" className="btn-secondary text-sm btn">
                📞 Call Now
              </a>
            </div>
        ...
        {open && (
          <div className="md:hidden bg-white border-t border-gray-100 shadow-card-hover">
            <nav className="flex flex-col px-4 py-3 gap-1" aria-label="Mobile navigation">
              ...
              <a href="tel:+918838893560" className="btn-secondary btn btn-lg mt-2 w-full justify-center">
                📞 Call Now: 88388 93560
              </a>
